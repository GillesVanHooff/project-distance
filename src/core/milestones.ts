...
const RAW: Array<[name: string, meters: number]> = [
  ['Ten Planck lengths', 1.6e-34],
  ['A hundred Planck lengths', 1.6e-33],
  ['A thousand Planck lengths', 1.6e-32],
  ['Grand unification scale', 1e-31],
  ['Quantum foam', 1e-30],
  ['Inflation ripple', 1e-29],
  ['Primordial wrinkle', 1e-28],
  ['Oh-My-God particle wavelength', 4e-27],
  ['A billion Planck lengths', 1.6e-26],
